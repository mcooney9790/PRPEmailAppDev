...
from emaillistcreator.views import delete_attachment
from emaillistcreator.views import delete_contact_list
from django.contrib import admin
from django.conf import settings
from django.conf.urls.static import static

#Admin Overrides/Initialization
admin.autodiscover()
admin.site.site_header = "PRP Email Blaster"
...
urlpatterns = [
    ...
    url(r'^delete-attachment/', delete_attachment),
    url(r'^delete-list-file/', delete_contact_list),
